    ...
    <section id="aboutconnectia" className="w-full py-20 font-lato">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-5">
            <div className="flex flex-col gap-4">
                ...
                >
                    A Full-Service IT Company in <span className="font-bold text-gray-400">Bengaluru</span><br className="hidden md:flex"/> Built for Growing Businesses
                </motion.h2>
                ...
                >
                    Founded in 2014, Connectia Technology provides complete IT and digital solutions. We work as a trusted digital partner for businesses. Our team of software developers, UI/UX designers, digital marketers, and IT consultants works together under one roof. That means faster decisions, consistent quality, and no handoff confusion across your project.
                </motion.p>
                ...
                >
                    We do not believe in one-size-fits-all solutions. Our team first understands your business, your goals, and your customers before starting any project. This helps us build technology solutions that truly support your business.
                </motion.p>
                ...
                >
                    "Great technology happens when deep technical expertise meets clear business strategy. That's the standard we hold ourselves to on every project."
                </motion.p>
            ...
            <div className="flex flex-col gap-4 min-h-[650px] overflow-y-scroll scroll-smooth hide-scrollbar">
                {features.map((f, idx) => (
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.6, ease: "easeOut", delay: idx * 0.08 + 0.12 }}
                    ...
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-gray-300 text-sm leading-relaxed">{f.description}</p>
                            </div>
                        </div>
                    </motion.div>
                ))}
