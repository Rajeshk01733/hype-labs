...
export const developmentData: DevelopmentData[] = [
  {
    ...
    icon: Monitor,
    shortDesc: 'We create high-performance, visually striking websites that blend aesthetics, usability, and powerful technology.',
    fullDesc: 'Our website development services are built to elevate your online presence, drive engagement, and deliver real business results through clean code, smart systems, and user-focused design.',
    ...
    faq: [
      {
        ...
        answer: "We develop corporate sites, landing pages, e-commerce stores, custom platforms, and high-performance business websites."
      },
      {
        question: "What platforms do you use?",
        answer: "We work with WordPress, Shopify, Webflow, custom frameworks (React, Next.js, Laravel), and more, depending on your needs."
      },
      {
        question: "Do you handle both design and development?",
        answer: "Yes. Our team manages the complete UI/UX design, development, testing, and launch."
      },
      {
        question: "How long does it take to build a website?",
        answer: "Most websites take 2–6 weeks, depending on complexity and features."
      },
      {
        question: "Will my website be mobile-friendly?",
        answer: "Absolutely, your website will be fully responsive across all screen sizes."
      },
      {
        question: "Do you provide SEO optimization?",
        answer: "Yes, we build with SEO-ready foundations and can provide full SEO services if needed."
      },
      {
        question: "Can I manage the website myself?",
        answer: "Yes, you will receive a user-friendly CMS with full editing control."
      },
      {
        question: "Do you offer e-commerce functionality?",
        answer: "Yes. We integrate secure payment gateways, checkout systems, and inventory management."
      },
      {
        question: "Do you provide hosting or domain services?",
        answer: "We guide you on the best options and can manage it for you if required."
      },
      {
        question: "What happens after the website is launched?",
        answer: "We offer support, maintenance, analytics integration, and performance monitoring."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
      { title: 'UX/UI Design', desc: 'Creating intuitive and engaging user interfaces.' },
      { title: 'Development', desc: 'Writing clean, efficient, and scalable code.' },
      { title: 'Launch', desc: 'Testing, optimizing, and deploying to production.' }
    ],
    portfolio: [
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc: 'We build high-performance mobile applications that deliver seamless user experiences, robust functionality, and intuitive design.',
    fullDesc: 'Our app development services bring your ideas to life, crafted with precision, built with modern technology, and optimized for long-term scalability.',
    subheadSection: {
    ...
    headlineSection: {
      ...
      description: "We develop applications that function flawlessly even under heavy load, deliver engaging user experiences, and adapt to the evolving needs of your business. With robust backend systems, seamless integrations, and modern features, our apps are crafted not just for today but for the future."
    },
    detailedFeatures: [
      {
    ...
    faq: [
      {
        ...
        answer: "We develop native iOS apps, Android apps, hybrid apps, enterprise applications, and custom business apps."
      },
      {
        question: "Do you help with UI/UX design?",
        answer: "Yes, our design team creates complete UI/UX layouts, user flows, wireframes, and prototypes."
      },
      {
        question: "Which technologies do you use?",
        answer: "We work with Swift, Kotlin, Flutter, React Native, Node.js, Laravel, Firebase, and scalable cloud environments."
      },
      {
        question: "How long does it take to build an app?",
        answer: "Simple apps take 4–8 weeks. Complex apps require 2–6 months, depending on features."
      },
      {
        question: "Can you maintain and update the app after launch?",
        answer: "Yes. We provide continuous support, bug fixes, and version upgrades."
      },
      {
        question: "Will my app support all devices?",
        answer: "Absolutely, our apps are optimized for different screen sizes and operating systems."
      },
      {
        question: "Do you offer backend development?",
        answer: "Yes, including admin dashboards, APIs, databases, and cloud infrastructure."
      },
      {
        question: "Can you add payment, chat, or tracking features?",
        answer: "Yes, we integrate payment gateways, live chat, push notifications, analytics, and more."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
    ...
    portfolio: [
      { title: 'Fintech Dashboard', category: 'Mobile App', image: 'https://images.unsplash.com/photo-1555421689-d68471e189f2?q=80&w=800&auto=format&fit=crop' },
      { title: 'E-Commerce Platform', category: 'Mobile App', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=800&auto=format&fit=crop' },
      { title: 'Fitness Tracker', category: 'Mobile App', image: 'https://images.unsplash.com/photo-1526498460520-4c246339dccb?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: 'ecommerce',
    ...
    icon: Monitor,
    shortDesc: 'We build high-performance e-commerce platforms designed to convert visitors into customers.',
    fullDesc: 'Our stores combine elegant design, smooth user journeys, fast checkout flows, and enterprise-grade functionality, delivering an online shopping experience your customers will love.',
    ...
    faq: [
      {
        ...
        answer: "We work with Shopify, WooCommerce, Magento, Webflow, and fully custom frameworks depending on your requirements."
      },
      {
        question: "Can you design the entire store layout?",
        answer: "Yes, we create complete UI/UX designs, including homepage, product pages, category pages, and checkout screens."
      },
      {
        question: "Do you integrate payment gateways?",
        answer: "Absolutely. We integrate credit/debit cards, wallets, UPI, PayPal, Apple Pay, Google Pay, and more."
      },
      {
        question: "Can I manage products myself?",
        answer: "Yes, you will receive a simple, intuitive dashboard to manage inventory, pricing, orders, and promotions."
      },
      {
        question: "Do you provide mobile optimization?",
        answer: "Yes, your store will be fully responsive and optimized for mobile shoppers."
      },
      {
        question: "Can you build a marketplace with multiple vendors?",
        answer: "Yes, we develop both single-vendor and multi-vendor e-commerce systems."
      },
      {
        question: "Do you offer marketing integrations?",
        answer: "Yes, CRM, email automation, WhatsApp, Facebook Pixel, Google Analytics, SEO tools, and remarketing systems."
      },
      {
        question: "What about abandoned cart recovery?",
        answer: "We set up automated tools to help recover lost sales and increase conversions."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc: 'We build powerful CRM systems that help businesses organize their data, automate workflows, and manage customers more efficiently.',
    fullDesc: 'Our CRM solutions streamline your entire customer lifecycle, from lead generation to after-sales support, giving you complete control, real-time insights, and a scalable foundation for growth.',
    heroImage: '/devlopment/crm/Banner.png',
    galleryHeading: 'Some of Our CRM Interface Designs',
    galleryDesc: '',
    galleryImages: [
      "/devlopment/crm/01.png",
      "/devlopment/crm/02.png",
    ],
    features: ['Custom Frontend Architecture', 'Headless CMS Integration', 'E-commerce Solutions', 'WebGL & 3D Interactions', 'Progressive Web Apps'],
    subheadSection: {
      title: "Your Customer Journey, Optimized.",
      description: "A CRM isn't just software, it's the core engine behind how your business communicates, sells, and grows. We design and develop CRM platforms tailored to your operations, industry, and long-term goals, ensuring your team works smarter rather than harder. From pipelines and automations to reporting dashboards and integrations, our CRM systems are built to improve workflows, enhance productivity, and increase revenue.",
    ...
    faq: [
      {
        ...
        answer: "We develop sales CRMs, service CRMs, support CRMs, pipeline management systems, and fully customized business CRMs."
      },
      {
        question: "Can you automate follow-up processes?",
        answer: "Yes, automated emails, WhatsApp messages, reminders, and task assignments."
      },
      {
        question: "Do you integrate CRM with websites and landing pages?",
        answer: "Absolutely. Leads flow automatically into your CRM with source tracking."
      },
      {
        question: "Can CRM support multi-team operations?",
        answer: "Yes, multiple departments, roles, permissions, and workflows can be added."
      },
      {
        question: "Do you offer mobile access?",
        answer: "Yes, your CRM can be accessed via mobile-friendly dashboards or custom apps."
      },
      {
        question: "Can you migrate our old data?",
        answer: "Yes, we handle database migration, cleanup, and system re-structuring."
      },
      {
        question: "How long does it take to build a CRM?",
        answer: "On average, 3–10 weeks, depending on complexity and number of modules."
      },
      {
        question: "Do you provide training?",
        answer: "Yes, we train your team and provide documentation for smooth onboarding."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
  ...
  },
  {
    ...
    fullDesc: 'We build powerful ERP systems that unify your business processes, automate daily tasks, and give you complete visibility across every department. Our ERP solutions are custom-built to match your workflows, helping you improve efficiency, reduce manual effort, and scale with confidence.',
    ...
    faq: [
      {
        ...
        answer: "We build ERPs for finance, HR, inventory, procurement, sales, projects, operations, and industry-specific workflows."
      },
      {
        question: "Can ERP be customized for my business?",
        answer: "Yes, every module, workflow, and feature is designed around your exact requirements."
      },
      {
        question: "Do you integrate third-party tools?",
        answer: "Absolutely. We integrate accounting tools, CRM, e-commerce platforms, WhatsApp, payment gateways, and automation tools."
      },
      {
        question: "How long does ERP development take?",
        answer: "Typically 4–12 weeks, depending on module complexity and business size."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes, we provide onboarding training, documentation, and ongoing support."
      },
      {
        question: "Is ERP secure?",
        answer: "We use role-based permissions, encryption, secure databases, and activity logs to keep your system safe."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc: 'Our POS solutions are designed to simplify transactions, streamline operations, and deliver a seamless checkout experience.',
    fullDesc: 'We build smart, scalable POS systems that integrate sales, inventory, billing, and reporting, helping businesses operate faster and smarter.',
    ...
    subheadSection: {
      ...
      description: "A modern POS system is more than just billing software, it's the backbone of your daily operations. We develop POS solutions that are intuitive, reliable, and built to handle high-volume transactions while giving you complete control and visibility over your business."
    },
    detailedFeatures: [
      {
    ...
    faq: [
      {
        ...
        answer: "Our POS systems are suitable for retail stores, restaurants, cafes, salons, supermarkets, and multi-location businesses."
      },
      {
        question: "Can the POS system integrate with inventory and accounting software?",
        answer: "Yes, our POS solutions integrate seamlessly with inventory management, CRM, ERP, and accounting platforms."
      },
      {
        question: "Do you support multiple payment methods?",
        answer: "Absolutely, cash, card, digital wallets, QR payments, and online integrations are supported."
      },
      {
        question: "Is the POS system cloud-based or offline?",
        answer: "We offer both cloud-based and hybrid POS systems with offline functionality to ensure uninterrupted operations."
      },
      {
        question: "Can the POS system be customized?",
        answer: "Yes, features, dashboards, user roles, and reports can be customized to match your business workflow."
      },
      {
        question: "Do you provide training and support?",
        answer: "Yes, we offer onboarding, staff training, and ongoing technical support."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
    ...
    faq: [
      {
        ...
        answer: "We build applications for operations, HR, finance, procurement, logistics, sales, production, projects, CRM, and custom enterprise use cases."
      },
      {
        question: "Can you integrate with our existing tools?",
        answer: "Yes. We integrate CRM, ERP, accounting software, POS, HRMS, and APIs that your organization already uses."
      },
      {
        question: "Is the system cloud-based?",
        answer: "It can be cloud-based, on-premise, or hybrid, depending on your organization's needs."
      },
      {
        question: "How secure are your enterprise solutions?",
        answer: "We follow enterprise-grade security standards, including encryption, multi-level access control, secure APIs, backups, and server hardening."
      },
      {
        question: "Do you support large databases and high user volume?",
        answer: "Yes, our architecture is built to handle high traffic, large datasets, and thousands of concurrent users."
      },
      {
        question: "How long does development take?",
        answer: "Typical timelines range from 6–20 weeks, depending on the complexity and number of modules."
      },
      {
        question: "Do you provide training and documentation?",
        answer: "Yes, your team receives complete training, user manuals, and onboarding support."
      },
      {
        question: "What industries do you work with?",
        answer: "Retail, hospitality, logistics, manufacturing, finance, healthcare, real estate, education, SaaS, and more."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
  ...
  },
  {
    ...
    fullDesc: 'We build intelligent AI chatbots that automate customer interactions, enhance user experience, and improve operational efficiency. From lead generation and customer support to e-commerce assistance and workflow automation, our chatbots deliver instant, accurate, and human-like responses 24/7.',
    ...
    subheadSection: {
      ...
      description: "Every customer expects quick answers, instant support, and a seamless experience. Our AI chatbot solutions transform the way your business communicates—helping you respond instantly, qualify leads, resolve queries, and personalize user interactions across websites, apps, WhatsApp, and social platforms. Built using advanced AI models, NLP (Natural Language Processing), and smart automation, our chatbots understand intent, learn continuously, and deliver meaningful conversations that drive results."
    },
    detailedFeatures: [
      {
    ...
    faq: [
      {
        ...
        answer: "It can answer FAQs, generate leads, book appointments, track orders, assist with sales, collect data, and automate customer support."
      },
      {
        question: "Can you integrate the chatbot on my website or app?",
        answer: "Yes, our chatbots work on websites, apps, WhatsApp, Instagram, Facebook, and internal systems."
      },
      {
        question: "Do your chatbots use AI or just predefined scripts?",
        answer: "We develop both AI-driven chatbots (NLP-based) and hybrid chatbots depending on your requirements."
      },
      {
        question: "Can the chatbot integrate with my CRM or ERP?",
        answer: "Absolutely. We support API integrations for seamless data flow and automation."
      },
      {
      ...
      {
        question: "How long does development take?",
        answer: "Typically 1–4 weeks, depending on complexity and integrations."
      },
      {
        question: "Can the chatbot handle payments or bookings?",
        answer: "Yes, booking engines, payment gateways, order tracking, and appointment systems can be integrated."
      },
      {
        question: "Does the chatbot improve over time?",
        answer: "Yes, AI chatbots learn from interactions and become smarter with usage."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc: 'Automated Conversations. Instant Engagement. Smarter Customer Experiences.',
    fullDesc: 'From automated replies to advanced workflows and chatbot intelligence, our WhatsApp API solutions enable businesses to deliver fast, personalized, and scalable communication.',
    heroImage: '/devlopment/whatsapp/Banner.png',
    galleryImages: [
      "/devlopment/whatsapp/01.png",
    ],
    features: ['Custom Frontend Architecture', 'Headless CMS Integration', 'E-commerce Solutions', 'WebGL & 3D Interactions', 'Progressive Web Apps'],
    detailedFeatures: [
      {
    ...
    faq: [
      {
        ...
        answer: "It enables businesses to automate messaging, run chatbots, send notifications, and manage high-volume communication professionally."
      },
      {
        question: "Do you help with the green tick verification?",
        answer: "Yes, we guide you through the verification and approval process."
      },
      {
        question: "Can WhatsApp API integrate with my CRM or ERP?",
        answer: "Absolutely. We support complete system integration for seamless automation."
      },
      {
        question: "Do you build WhatsApp chatbots?",
        answer: "Yes, AI-powered chatbots, rule-based bots, hybrid bots, and industry-specific conversational flows."
      },
      {
        question: "Can I send bulk promotional messages?",
        answer: "Yes, using WhatsApp-approved message templates and broadcast campaigns."
      },
      {
        question: "Can WhatsApp API help reduce abandoned carts?",
        answer: "Yes, automated cart reminders significantly improve conversion rates."
      },
      {
        question: "What about analytics?",
        answer: "We provide dashboards that track message delivery, response rates, user interactions, and performance insights."
      },
      {
        question: "Does WhatsApp API support payments?",
        answer: "Yes, we can integrate payment links, checkout flows, and order confirmations."
      }
    ],
    process: [
      { title: 'Discovery', desc: 'Analyzing requirements and defining the technical roadmap.' },
