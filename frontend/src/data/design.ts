...
export const designData: DesignData[] = [
  {
    ...
    faq: [
      {
        question:
          "Q1. What makes Connectia one of the top UI/UX design agencies in Bangalore?",
        answer:
      ...
      {
        question:
          "Q2. What are the key benefits of investing in professional UI/UX design for your product?",
        answer:
      ...
      {
        question:
          "Q3. What are the best platforms and services for UI/UX website design in India?",
        answer:
      ...
      {
        question:
          "Q4. How do you choose the right UI/UX design agency for your website project?",
        answer:
      ...
      {
        question:
          "Q5. Does Connectia offer UI/UX design for both mobile apps and web apps, and is it suitable for startups?",
        answer:
    ...
    cta: {
      ...
      subtitle:
        "Let's collaborate with a UI UX design company Bangalore and create something extraordinary together.",
    },
    ...
    meta: {
      ...
      description:
        "UI UX design company Bangalore offering UI UX design services and digital product design. Improve user experience with Connectia.",
    },
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Build a strong brand with expert brand strategy services. Define positioning, messaging & identity with Connectia.",
    },
    ...
    cta: {
      title: "Ready to bring your vision to life?",
      subtitle:
        "Let's collaborate and build something extraordinary together with expert brand strategy.",
    },
  },
  {
    id: "social-branding",
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc:
      "We create memorable, timeless, and high-impact logos that define your brand identity and set the foundation for your entire visual presence.",
    fullDesc:
      "Our professional logo design services blend strategy, creativity, and precision—resulting in a brand logo that truly represents who you are, aligned with modern user interface design standards from an Indian website design company.",
    ...
    // Gallery Description
    galleryDesc:
      "Your logo is the face of your brand - the first thing customers notice and the last thing they remember. We craft logos that are visually powerful, strategically meaningful, and built for long-term recognition.",
    ...
    subheadSection: {
      ...
      description:
        "Your logo is the face of your brand - the first thing customers notice and the last thing they remember. As a leading brand logo design agency, we craft logos that are visually powerful, strategically meaningful, and built for long-term recognition.",
    },
    ...
    headlineSection: {
      ...
      description:
        "We don't just create logos - we create brand symbols. Every curve, angle, line, and color is chosen to reflect your personality, values, and positioning. Our process ensures your logo design is original, scalable, and instantly recognizable.",
    },
    ...
    faq: [
      {
        ...
        answer:
          "We design wordmarks, symbols, minimal logos, icons, monograms, luxury logos, and complete brand identity marks tailored to your brand.",
      },
      {
        question: "Can I request multiple logo concepts?",
        answer:
          "Yes, we provide multiple custom logo concepts for you to choose from, ensuring you find the perfect direction.",
      },
      {
        question: "Will I get the source files?",
        answer:
          "Yes. You receive all formats: AI, EPS, PNG, SVG, PDF, black/white versions, and more for complete flexibility.",
      },
      {
        question: "How long does a logo design project take?",
        answer:
          "Typically 3–10 days depending on revisions and complexity of the design requirements.",
      },
      {
        question: "Can you redesign my existing logo?",
        answer:
          "Yes, we offer logo redesign services for outdated or inconsistent identities that need a fresh direction.",
      },
      {
        question: "Do you create full brand identity kits?",
        answer:
          "Absolutely. We offer logo design, typography, colors, patterns, brand guidelines, business cards, and more.",
      },
      {
        question: "Is the logo designed from scratch?",
        answer:
          "Yes. Every logo concept is original, unique, and tailored specifically to your brand with no templates.",
      },
    ],
    ...
    process: [
      {
        title: "Discovery",
        desc: "Understanding your brand values, audience, and design preferences.",
      },
      {
        title: "Research",
        desc: "Analyzing competitors and industry trends for strategic direction.",
      },
      {
        title: "Concept Development",
        desc: "Sketching and exploring multiple logo directions and ideas.",
      },
      {
        title: "Design",
        desc: "Creating digital versions of selected concepts with precision.",
      },
      {
        title: "Refinement",
        desc: "Iterating based on feedback to perfect the chosen direction.",
      },
      {
        title: "Delivery",
        desc: "Providing complete file packages and brand usage guidelines.",
      },
    ],
    ...
    portfolio: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1626785774573-4b7994893459?q=80&w=800&auto=format&fit=crop",
      },
      {
        title: "Tech Startup",
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc:
      "We help businesses build product identities that stand out on the shelf, online, and in the minds of their customers.",
    fullDesc:
      'From packaging and visual identity to storytelling and positioning, our product branding services are designed to elevate your product from "just another item" to a brand people trust and choose using impactful creative design agency approaches seen in the best design agencies in India.',
    heroImage: "/desgin/product-branding/Banner.png", // Product packaging/branding image

    // Gallery Images (for portfolio section)
    galleryImages: ["/desgin/product-branding/01.png"],
    ...
    // Gallery Description
    galleryDesc:
      "Explore product branding projects that transformed ideas into market-ready brands with distinct visual identities.",
    ...
    headlineSection: {
      ...
      description:
        "A great product sells once. A great product brand sells forever. We build identities that turn casual buyers into loyal advocates through strategic design and compelling storytelling.",
    },
    ...
    faq: [
      {
        ...
        answer:
          "Product branding includes brand positioning, packaging design, visual identity, product storytelling, naming, messaging, market research, and complete brand guidelines.",
      },
      {
        question: "Can you create packaging for my product?",
        answer:
          "Yes, we design labels, boxes, bottles, sleeves, pouches, and all product packaging elements tailored to your category.",
      },
      {
        question: "Do you help with the product name and tagline?",
        answer:
          "Absolutely. Naming and tagline creation are important parts of our product branding strategy to ensure memorability.",
      },
      {
        question: "Can you rebrand an existing product?",
        answer:
          "Yes, we specialize in modernizing outdated product identities and repositioning them for new audiences and markets.",
      },
      {
        question: "How long does product branding take?",
        answer:
          "Most projects take 2–6 weeks, depending on complexity, number of SKUs, and deliverables required.",
      },
      {
        question: "Do you design brand guidelines for the product?",
        answer:
          "Yes, every project includes a full brand guide covering colors, fonts, usage rules, packaging specifications, and more.",
      },
    ],
    ...
    process: [
      {
        title: "Discovery",
        desc: "Understanding your product, market, and business objectives.",
      },
      {
        title: "Research",
        desc: "Category analysis, competitor audit, and consumer insights.",
      },
      {
        title: "Positioning",
        desc: "Defining your product's unique space and value proposition.",
      },
      {
        title: "Visual Identity",
        desc: "Creating packaging, logos, and design systems.",
      },
      {
        title: "Storytelling",
        desc: "Developing product narratives and messaging frameworks.",
      },
      {
        title: "Guidelines",
        desc: "Delivering complete brand guides and specifications.",
      },
    ],
    ...
    portfolio: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1542744094-3a31f272c2d0?q=80&w=800&auto=format&fit=crop",
      },
      {
        title: "Premium Beverage Brand",
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc:
      "We build powerful personal brands for entrepreneurs, creators, founders, coaches, and professionals who want to stand out, gain authority, and communicate their story with intention.",
    fullDesc:
      "Our personal branding services go far beyond aesthetics. We create a brand presence that reflects who you are, what you stand for, and the impact you aim to make with strong brand design services from a trusted website design company in India.",
    ...
    // Gallery Description
    galleryDesc:
      "Explore personal brands we've built for entrepreneurs, creators, and professionals across industries.",
    ...
    subheadSection: {
      ...
      description:
        "A strong personal brand opens doors, builds trust, and positions you as a leader in your space. From visual identity to messaging and content direction, we craft a personal brand system that feels authentic, polished, and strategically aligned to your goals. Whether you're building credibility, scaling your career, attracting clients, or becoming a public figure, your brand should reflect your value with clarity and confidence.",
    },
    ...
    headlineSection: {
      ...
      description:
        "In a crowded digital world, your personal brand is your greatest asset. We help you cut through the noise with an authentic identity that attracts opportunities and builds lasting influence.",
    },
    ...
    faq: [
      {
        ...
        answer:
          "Entrepreneurs, influencers, executives, consultants, coaches, creators, and anyone who wants to build authority and stand out professionally.",
      },
      {
        question: "What is included in your personal branding service?",
        answer:
          "Brand identity, messaging, personal logo, visual direction, social media branding, content pillars, and a complete personal brand kit.",
      },
      {
        question: "Can you help me grow my social media presence?",
        answer:
          "Yes, our team creates a structured content and visual system optimized for engagement and growth across platforms.",
      },
      {
        question: "Do you offer personal logo design?",
        answer:
          "Absolutely. We create custom monograms, signature logos, and identity marks tailored to your personality and professional presence.",
      },
      {
        question: "How long does the personal branding process take?",
        answer:
          "Usually 1–3 weeks, depending on the scope and complexity of your personal brand needs.",
      },
      {
        question: "Can you help me redesign my current personal brand?",
        answer:
          "Yes, we offer audits and complete personal brand transformations to modernize and strengthen your presence.",
      },
    ],
    ...
    process: [
      {
        title: "Discovery",
        desc: "Understanding your story, values, and professional goals.",
      },
      {
        title: "Positioning",
        desc: "Defining your niche, authority, and target audience.",
      },
      {
        title: "Story Development",
        desc: "Crafting your personal narrative and messaging framework.",
      },
      {
        title: "Visual Identity",
        desc: "Creating logos, colors, and visual systems that reflect you.",
      },
      {
        title: "Content Strategy",
        desc: "Building content pillars and direction for engagement.",
      },
      {
        title: "Brand Kit",
        desc: "Delivering complete personal brand assets and guidelines.",
      },
    ],
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc:
      "We craft high-impact corporate presentations that communicate your brand story, business strategy, and key messages with clarity and visual excellence.",
    fullDesc:
      "From investor decks to internal reports and sales presentations, our designs transform complex information into compelling, easy-to-understand narratives using website design services principles followed by top design agencies in India.",
    ...
    // Gallery Description
    galleryDesc:
      "Explore corporate presentations that communicate strategy, vision, and data with clarity and visual impact.",
    ...
    headlineSection: {
      ...
      description:
        "Your ideas deserve to be seen and understood. We transform complex data and strategy into visually compelling narratives that captivate investors, clients, and stakeholders.",
    },
    ...
    faq: [
      {
        ...
        answer:
          "We design pitch decks, company profiles, sales decks, training presentations, annual reports, business reviews, event presentations, and more.",
      },
      {
        question: "Do you help with content writing and storytelling?",
        answer:
          "Yes, we can refine your content, structure your narrative, and craft your message clearly and persuasively for maximum impact.",
      },
      {
        question: "Can you redesign an existing presentation?",
        answer:
          "Absolutely. We can modernize outdated slides and redesign them into a polished, professional deck that reflects your current brand.",
      },
      {
        question: "Do you provide editable files?",
        answer:
          "Yes, you will receive PowerPoint, Google Slides, or Keynote versions depending on your preference for easy updates.",
      },
      {
        question: "How long does a presentation design project take?",
        answer:
          "Typically 3–10 days depending on complexity and number of slides required for your presentation.",
      },
      {
        question: "Can you handle investor-focused presentations?",
        answer:
          "Yes, we specialize in investor decks that highlight traction, opportunity, financial clarity, and growth potential.",
      },
    ],
    ...
    process: [
      {
        title: "Discovery",
        desc: "Understanding your audience, goals, and key messages.",
      },
      {
        title: "Content Structuring",
        desc: "Organizing your narrative and information flow.",
      },
      {
        title: "Visual Strategy",
        desc: "Developing layout systems, typography, and infographic styles.",
      },
      {
        title: "Design",
        desc: "Creating slide decks with high-end visuals and clean layouts.",
      },
      {
        title: "Review & Refinement",
        desc: "Iterating based on feedback to perfect the presentation.",
      },
      {
        title: "Delivery",
        desc: "Providing editable files and master templates for future use.",
      },
    ],
  ...
  },
  {
    ...
    icon: Monitor,
    shortDesc:
      "We create dynamic, high-impact AI-generated videos and animations that help brands communicate faster, scale content production, and deliver visually stunning experiences at a fraction of the traditional time and cost.",
    fullDesc:
      "From product explainers to hyper-realistic visuals, our AI video services unlock creative possibilities that were once impossible, enhancing overall digital product design experiences from an innovative Indian website design company.",
    ...
    // Gallery Description
    galleryDesc:
      "Explore AI-generated videos and animations that push creative boundaries while delivering faster, cost-effective production.",
    ...
    headlineSection: {
      ...
      description:
        "AI allows brands to create stunning visuals without traditional studio constraints. We help you harness that power, transforming your creative vision into dynamic AI-generated videos that look premium, feel authentic, and deliver measurable impact.",
    },
    ...
    faq: [
      {
        ...
        answer:
          "We create product videos, character animations, explainer videos, AI avatars, 3D renders, and social media videos tailored to your brand.",
      },
      {
        question: "Are AI videos customizable?",
        answer:
          "Yes, every visual, scene, script, and animation style can be tailored to your brand identity and creative vision.",
      },
      {
        question: "Do AI videos replace traditional production?",
        answer:
          "Not always, but they significantly reduce cost, time, and effort while offering creative flexibility that traditional production can't match.",
      },
      {
        question: "How long does it take to produce an AI video?",
        answer:
          "Most projects are completed within 3–7 days, depending on length, complexity, and customization requirements.",
      },
      {
        question: "Do you provide voiceovers and sound design?",
        answer:
          "Yes, AI voiceovers and audio enhancements are included to create a complete, professional video experience.",
      },
      {
        question: "Can you match my brand identity in the video?",
        answer:
          "Absolutely. Colors, typography, tone, and visual style are customized to align with your brand guidelines perfectly.",
      },
    ],
    ...
    process: [
      {
        title: "Discovery",
        desc: "Understanding your creative vision, goals, and brand identity.",
      },
      {
        title: "Script Development",
        desc: "Crafting compelling narratives and dialogue for your video.",
      },
      {
        title: "Style Selection",
        desc: "Choosing visual aesthetics, animation styles, and AI models.",
      },
      {
        title: "AI Generation",
        desc: "Creating visuals, scenes, and animations using advanced AI tools.",
      },
      {
        title: "Voice & Sound",
        desc: "Adding AI voiceovers, music, and sound design.",
      },
      {
        title: "Delivery",
        desc: "Providing final videos optimized for your target platforms.",
      },
    ],
